...
impl Serialize for Value {
        ...
        S: ::serde::Serializer,
    {
        match *self {
            ...
            Value::Integer(ref n) => serializer.serialize_i64(*n),
            Value::Float(ref n) => serializer.serialize_f64(*n),
...
impl serde::Serializer for Serializer {
    ...
    fn serialize_bytes(self, value: &[u8]) -> Result<Value, Error> {
        let vec = value.iter().map(|&b| Value::Integer(b as i64)).collect();
        Ok(Value::Array(vec))
    }
